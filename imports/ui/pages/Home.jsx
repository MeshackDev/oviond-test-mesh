    ...
    <>
      <Header>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 w-full">
          ...
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={handleAdd}>Add Client</button>
        </div>
      </Header>

      <section className='min-w-0 flex-1 h-full flex flex-col lg:order-last overflow-y-auto p-4 md:p-8 bg-slate-50'>
        <ClientList/>
      </section>
    </>
  )
